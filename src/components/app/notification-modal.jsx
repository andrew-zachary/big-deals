        ...
        >
            <div id="notification-modal-content" className='flex flex-col justify-between p-6 h-full'>
                ...
                <div className="ctrls flex justify-around">
                    <button className='font-ssp font-regular text-4xl bg-primary dark:bg-primary-dark shadow-secondary text-white px-8 py-4 rounded-[0.4rem] capitalize' onClick={()=>closeModal()}>ok</button>
                </div>
            </div>
        </Modal>
    </div>
