...
const BDFormInput = ({htmlInput, htmlInputErr, id, name, type, label, value, onChange, onBlur, errors, touched}) => {
    ...
    const labelStyle = 'bd-font-compo text-[2rem] text-black dark:text-white capitalize font-regular absolute pointer-events-none top-[1rem] ease-in-out duration-300';
