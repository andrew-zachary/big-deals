    ...
    return <>
        {
            userInfo._id && <div id='user-profile' className='grid content-center'> 
                <div id='user-info-header'>
                    ...
                    <span className='mt-10 block text-5xl font-regular capitalize'>hi {userInfo.authId.firstName}</span>
                </div>
                <div id='user-info-body' className='flex flex-col items-center justify-center'>
                    ...
                    <div className="ctrls mt-20 flex justify-around items-center w-full">
                        ...
                        <button className='bd-unit px-4 py-8 rounded-full border-2 border-primary dark:border-primary-dark bg-primary dark:bg-primary-dark font-regular text-white text-4xl capitalize shadow-secondary' onClick={()=>setCurrentPage('orders')}>bills</button>
