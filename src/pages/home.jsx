...
const HomePage = () => {
    return <div id="home-page" className='content-page flex flex-col items-center justify-center'>
        ...
        <Link className='font-ssp font-regular text-4xl bg-primary dark:bg-primary-dim-dark shadow-secondary text-white px-8 py-4 rounded-[0.4rem] capitalize' to="/shopping" path="shopping">shopping now</Link>
    </div>
}
